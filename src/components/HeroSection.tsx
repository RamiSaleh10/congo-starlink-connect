...
const HeroSection = ({ language }: HeroSectionProps) => {
  ...
  return (
    <section 
      className="relative text-white py-32 md:py-48 bg-cover bg-center cursor-pointer" 
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 
            className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-fade-in text-gradient cursor-pointer hover:text-starlink-light-blue transition-colors"
            onClick={scrollToProducts}
          >
            {text.heading}
          </h1>
          <p 
            className="text-lg md:text-xl mb-8 text-starlink-sky-blue animate-fade-in cursor-pointer hover:text-white transition-colors"
            onClick={scrollToProducts}
          >
            {text.subheading}
          </p>

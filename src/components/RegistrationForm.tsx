    ...
    if (validate()) {
      ...
      setTimeout(() => {
        ...
        toast({
          ...
          description: language === 'en' ? "Thank you for your interest in Starlink!" : "Merci pour votre intérêt pour Starlink!"
        });
      }, 1500);
    }
  };
  return <section className="py-16 bg-starlink-light-gray" id="register">
      <div className="container mx-auto px-4 bg-starlink-background">
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-6">
              <div>
                ...
                <input type="text" id="fullName" name="fullName" value={formData.fullName} onChange={handleChange} placeholder={text.placeholders.fullName} className="input-field" />
              ...
              <div>
                ...
                <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} placeholder={text.placeholders.email} className="input-field" />
              ...
              <div>
                ...
                <input type="text" id="nationality" name="nationality" value={formData.nationality} onChange={handleChange} placeholder={text.placeholders.nationality} className="input-field" />
              ...
              <div>
                ...
                <textarea id="address" name="address" value={formData.address} onChange={handleChange} placeholder={text.placeholders.address} className="input-field min-h-[100px]" />
              ...
              <div>
                ...
                <input type="text" id="company" name="company" value={formData.company} onChange={handleChange} placeholder={text.placeholders.company} className="input-field" />
              </div>

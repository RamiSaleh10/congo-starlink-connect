  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <h2 
          className="text-3xl font-bold text-starlink-dark-blue text-center mb-10 cursor-pointer hover:text-starlink-light-blue transition-colors"
          ...
          {text.benefits.map((benefit, index) => (
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 
                  className="text-xl font-semibold text-starlink-dark-blue mb-3 cursor-pointer hover:text-starlink-light-blue transition-colors"
                  onClick={scrollToProducts}
                >
                  {benefit.title}
                </h3>
